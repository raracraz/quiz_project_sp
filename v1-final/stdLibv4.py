...
def doAdminUserEditData(userid,column,value):
    if column == '1':
        UserDB.update('users', 'username', 'id', 'raw', value, userid)
    elif column == '2':
        UserDB.update('users', 'password', 'id', 'raw', value, userid)
    elif column == '3':
        UserDB.update('users', 'email', 'id', 'raw', value, userid)
    elif column == '4':
        UserDB.update('users', 'acl', 'id', 'raw', value, userid)
    elif column == '5':
        UserDB.update('users', 'otp', 'id', 'raw', value, userid)
    else:
